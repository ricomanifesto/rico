      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <nav className="flex items-center ml-8">
            ...
            <a href="#projects" className="mr-6 text-sm text-gray-200 transition duration-300" onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#007bff'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = ''}>Projects</a>
            <a href="mailto:michaelrico124@gmail.com" className="text-sm text-gray-200 transition duration-300" onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#007bff'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = ''}>Contact</a>
          </nav>
        </div>
        ...
        <div className="flex items-center space-x-3">
          <a href="mailto:michaelrico124@gmail.com" aria-label="Email" 
             className="transition duration-300 transform hover:scale-110" style={{color: '#007bff'}} onMouseEnter={(e) => (e.target as HTMLElement).style.color = '#0056b3'} onMouseLeave={(e) => (e.target as HTMLElement).style.color = '#007bff'}>
