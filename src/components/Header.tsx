      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <nav className="flex items-center ml-8">
            <a href="#projects" className="mr-6 text-dark-text hover:text-secondary transition duration-300">Projects</a>
            <a href="mailto:michaelrico124@gmail.com" className="text-dark-text hover:text-secondary transition duration-300">Contact</a>
          </nav>
        </div>
